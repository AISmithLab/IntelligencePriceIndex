...
| R3 | "Does the conclusion quote anything the body does not support?" | major | **PASS** | Every figure traces to `data/pilot/paper-numbers.md` or to a numbered result in §3–§4: +40.7% real / +78.4% nominal / ±3.7% / CPI-U +26.8%; +7.7% per doubling; +39.7% to +79.0% band; ±23% to ±66% MDEs; −14.8% to +87.6% DiD interval; ρ = +0.314; 850–2,500 matched gigs. No new numbers are introduced. |
