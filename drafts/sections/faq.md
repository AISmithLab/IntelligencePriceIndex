...
### 4. What exactly is being priced?
...
### [NEW] 6. Why Fiverr — and what about Upwork?
...
### 7. How is the index calculated? (the formulas)
...
### [NEW] 8. Are these prices adjusted for general inflation?
...
### 9. How are the category weights set?
...
### 10. Why geometric means instead of plain averages?
...
### [NEW] 11. Could a few sellers distort the index?
...
### 12. Why can I switch categories on and off?
...
### [NEW] 15. Found an error, or want to contribute?
...
## Proposed FUTURE questions

> Placement note: insert these into 'index.html' and the table-of-contents in the order shown below.
> Suggested positions are noted on each item. None of these touch category definitions (for later versions).

### A. What time period does the chart cover right now?
...
3. What does the headline number mean?
   **`[FUTURE QUESTION]`** What time period does the chart cover right now?
4. What exactly is being priced?
5. Where does the data come from?
6. **`[NEW]`** Why Fiverr — and what about Upwork?
7. How is the index calculated? (the formulas)
8. **`[NEW]`** Are these prices adjusted for general inflation?
9. How are the category weights set?
10. Why geometric means instead of plain averages?
11. **`[NEW]`** Could a few sellers distort the index?
12. Why can I switch categories on and off?
13. What are the limitations and caveats?
14. Can I reproduce this?
15. **`[NEW]`** Found an error, or want to contribute?
